...
public class PhoneNumbersRepository {
    ...
    public JSONArray getPhoneBook(){
        ...
        try {
            ...
            String sql = "SELECT \"PHONENUMBERS\".\"ID\" AS \"ID\", \"PHONENUMBERS\".\"VALUE\" " +
                    "AS \"NUMBER\", \"PERSONS\".\"NAME\" AS \"NAMEPERSON\" FROM \"PHONENUMBERS\" " +
                    "LEFT JOIN \"PERSONS\" ON \"PERSONS\".\"ID\" = \"PHONENUMBERS\".\"ID_PERSON\";";
